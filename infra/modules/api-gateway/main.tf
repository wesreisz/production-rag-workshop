...
resource "aws_api_gateway_integration" "video_ask" {
  rest_api_id             = aws_api_gateway_rest_api.this.id
  resource_id             = aws_api_gateway_resource.video_ask.id
...
resource "aws_api_gateway_deployment" "this" {
  ...
  triggers = {
    redeployment = sha1(jsonencode([
      ...
      aws_api_gateway_resource.video_id.id,
      aws_api_gateway_resource.video_ask.id,
      aws_api_gateway_resource.health.id,
      aws_api_gateway_method.post_ask.id,
      aws_api_gateway_method.get_videos.id,
      aws_api_gateway_method.post_video_ask.id,
      aws_api_gateway_method.get_health.id,
      aws_api_gateway_integration.ask.id,
      aws_api_gateway_integration.videos.id,
      aws_api_gateway_integration.video_ask.id,
